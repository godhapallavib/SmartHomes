...
public class InventoryReport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		{
			pw.print("Bar Chart with the product names and the total products available");
            ...
            pw.println("['Product Name', 'Total Products available'],");
            ...
            pw.println("title: 'product names and the total products available',");
            pw.println("chartArea: {width: '50%', height: '50%'},");
            pw.println("hAxis: {");
            pw.println("title: 'Total Products available',");
